<div class="modal fade" id="editarMiembroModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <select type="text" class="form-control @error('tipoDocumento') is-invalid @enderror"
                    wire:model='tipoDocumento' disabled>
                ...
                <input type="text" maxlength="10" class="form-control @error('numeroDocumento') is-invalid @enderror"
                    wire:model='numeroDocumento' disabled>
